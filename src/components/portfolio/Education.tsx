            ...
            <Reveal key={it.degree} delay={i * 0.07}>
              <div className="glass rounded-2xl p-6 h-full hover-lift">
                <div className="flex items-start justify-between mb-4">
                  <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-primary to-accent grid place-items-center">
                    <GraduationCap className="w-5 h-5 text-primary-foreground" />
                  </div>
                  {it.verified && (
                    <span className="inline-flex items-center gap-1 text-xs text-primary glass px-2 py-1 rounded-full">
                      <BadgeCheck className="w-3.5 h-3.5" /> Verified
                    </span>
                  )}
                </div>
                <h3 className="font-bold text-lg mb-1 leading-snug">{it.degree}</h3>
                <p className="text-sm text-muted-foreground mb-4">Passing year: {it.year}</p>
                <div className="space-y-2 text-sm">
                  ...
                  <div className="flex justify-between gap-3">
                    ...
                    <span className="text-primary font-semibold">{it.result}</span>
                  </div>
                </div>
              </div>
            </Reveal>
